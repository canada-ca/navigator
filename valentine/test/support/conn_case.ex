defmodule ValentineWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use ValentineWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use ValentineWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import ValentineWeb.ConnCase
    end
  end
