defmodule Valentine.Repo.Migrations.CreateBrainstormItems do
  ...
  def change do
    ...
    create constraint(:brainstorm_items, :valid_type,
      check: "type IN ('threat', 'assumption', 'mitigation', 'evidence', 'requirement', 'asset', 'component', 'attack_vector', 'vulnerability', 'impact', 'control', 'risk', 'stakeholder', 'boundary', 'trust_zone', 'data_flow', 'process', 'data_store', 'external_entity')"
    )
