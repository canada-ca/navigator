defmodule ValentineWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ValentineWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ValentineWeb.Gettext, "errors", msg, opts)
    end
  end
